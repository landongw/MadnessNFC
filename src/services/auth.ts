...
export class AuthService {
  ...
  onPhoneNumber(phoneNumber: string, buttonId: string) {

    const RecaptchaVerifier = new firebase.auth.RecaptchaVerifier(buttonId, {
      'size': 'normal',
    ...
    window.localStorage.setItem('emailForSignIn', phoneNumber);
    console.log(RecaptchaVerifier);
    this.service.auth.signInWithPhoneNumber(phoneNumber, RecaptchaVerifier).then(function (confirmationResult) {
